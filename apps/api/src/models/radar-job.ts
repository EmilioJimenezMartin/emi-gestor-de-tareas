...
export interface IRadarJob extends Document {
    jobId: string;
    url: string;
    mode: "etsy-niches" | "amazon-niches" | "general" | "trends-niches" | "opportunity" | "amazon-movers" | "reddit-niches" | "cross-niche" | "gap-finder" | "gumroad-niches" | "pinterest-niches";
    geminiModel?: string;
    nicheName?: string;
    context?: string;
    storageKey?: string;
...
const RadarJobSchema = new Schema<IRadarJob>(
    {
        ...
        mode: { type: String, enum: ["etsy-niches", "amazon-niches", "general", "trends-niches", "opportunity", "amazon-movers", "reddit-niches", "cross-niche", "gap-finder", "gumroad-niches", "pinterest-niches"], default: "general" },
