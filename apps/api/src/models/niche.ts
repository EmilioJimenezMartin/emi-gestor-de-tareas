...
export interface INiche extends Document {
    ...
    confirmedPrompts?: Array<{ prompt: string; source: "comparator" | "discovery" | "clone"; addedAt: Date }>;
    phaseChangedAt?: Date;
...
const NicheSchema = new Schema<INiche>(
    {
        ...
        styleCategory: { type: String, enum: ["generic", "funko", "anime", "illustration", "children", "realistic", "watercolor", "abstract", "wall-art", "botanical", "affirmation", "geometric", "celestial", "retro"], default: "generic" },
        styleCategories: [{ type: String, enum: ["generic", "funko", "anime", "illustration", "children", "realistic", "watercolor", "abstract", "wall-art", "botanical", "affirmation", "geometric", "celestial", "retro"] }],
        ...
        confirmedPrompts: [{
            ...
            source: { type: String, enum: ["comparator", "discovery", "clone"], default: "comparator" },
